            ...
            if(is != 0)
            {
                while(1)
                {
                    ...
                    if (choice == 3)
                    {
                        ...
                        if(t == 1)
                        {
                            player1->credits = player1->credits + 10000;
                            update_player_info();
                            update_highscore();
                        }
                    }
                    if (choice == 4)
                    {
                        ...
                        while(1)
                        {
                            ...
                            else if(interChoose == 2)
                            {
                                
                                score_tic = tic_rand_play();
                                if (score_tic == -1)
                                {
                                    draw();
                                    player1->credits += 10;
...
int answer_by_letter(char *answer, int len)
{
    ...
    for(int i = 0; i < len * 1.4; i++)
    {
        ...
        char tem = getchar();
        scanf("%c", &char_answer);
        char_answer = tolower(char_answer);
        for(int j = 0; j < len; j++)
